        ...
        switch (args.length) {
            case 1:
                ...
                for (int i = 0; i < commandList.size() - 1; i++) { //all commands except last one
                    ...
                    if (CommandMDE.canUseCommand(sender,CommandMDE.getCommandPermission(name),CommandMDE.instance,name)) {
                ...
                if (CommandMDE.canUseCommand(sender,CommandMDE.getCommandPermission(name),CommandMDE.instance,name)) { //final command and formatting
            ...
            case 2:
                ...
                if (!CommandMDE.getCommandExists(commandName)) AbstractCommand.throwNoCommand();
